					...
					<Box>
						...
						>
							<AccordionSummary
								...
								id="panel1bh-header"
							>
								<Typography sx={{ width: "33%", flexShrink: 0 }}>Inscrições</Typography>
						...
						>
							<AccordionSummary
								...
								id="panel2bh-header"
							>
								<Typography sx={{ width: "33%", flexShrink: 0 }}>Edição</Typography>
								<Typography sx={{ color: "text.secondary" }}>
							...
							<AccordionDetails>
								<Stack direction="column" spacing={2} sx={{ width: "100%" }}>
									...
									<Typography variant="body2" sx={{ color: "text.secondary" }}>
										...
										alterar a edição atual modifica a edição no ato da inscrição do
										candidato
									</Typography>
									<Typography variant="body2" sx={{ color: "text.secondary" }}>
