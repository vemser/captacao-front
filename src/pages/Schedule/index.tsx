...
export const Schedule = () => {
	...
	const [entrevistasList, setEntrevistasList] = useState<
		EntrervistaResponse | undefined
	>(undefined);

	const { register, handleSubmit } =
		useForm<IAtualizarInformacoesEntrevista>();
		...
		return {
			...
			extendedProps: {
				...
				parecerComportamental:
					entrevista.candidatoDTO.parecerComportamental,
				...
				data.observacao &&
					(await toast.promise(
						...
						}).unwrap(),
						{
							pending: "Carregando...",
							success:
								"Observações da Entrevista atualizada com sucesso",
							error: {
								render() {
				...
				data.notaTecnica &&
					...
					(await toast.promise(
						...
						}).unwrap(),
						{
							pending: "Carregando...",
							success:
								"Nota e Parecer Técnico do candidato atualizado com sucesso",
							error: {
								render() {
	...
	return (
		<>
			...
			>
				...
				<Box maxWidth="80%" display="flex" mb="5%">
								...
								>
									...
									>
										...
										<Box
											...
											component={"span"}
										>
											{modalInfos?.extendedProps.cidade}/
											{modalInfos?.extendedProps.estado}
										</Box>
									</Typography>
